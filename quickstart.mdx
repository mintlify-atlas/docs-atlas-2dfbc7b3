---
title: "ThunderRAR: Clone, Build, and Run in Android Studio"
sidebarTitle: "Quickstart"
description: "Clone the ThunderRAR repository, open it in Android Studio, and run the app on an emulator or physical device in under ten minutes."
---
